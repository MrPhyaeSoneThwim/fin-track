...
const EditTransaction = ({ open, onOpenChange, editId }) => {
	...
	useEffect(() => {
		if (editId) {
			...
			form.setValue("createdAt", transaction.createdAt);
		}
	}, [editId]);

	function onSubmit(values) {
		updateTransaction({ ...values, _id: editId });
		form.reset();
		onOpenChange();
	}
		...
		<Dialog open={open}>
			<DialogContent className="sm:max-w-[425px]">
				<DialogHeader>
					...
					<DialogDescription>
						Enter the details of your new transaction below to update.
					</DialogDescription>
				</DialogHeader>
				<Form {...form}>
